    ...
    public static void main(String[] args) throws IOException {
       ...
       /* String[] strings = set2.stream().toArray(String[]::new);
        for(int i5=0;i5<1;i5++){
            ...
            Elements ell = document.getElementsByAttributeValue(others.attribute.attributename(strings[i5]), others.attribute.attributevalue(strings[i5]));
            JSONArray arr = new JSONArray();
            for (Element at : ell) {
                if (others.attribute.hasAHref(at) == true && others.attribute.hasImgSrc(at) == true && at.hasText() == true) {
 ...
 */
 ...
 /*  Elements ell = document.getElementsByAttributeValue("class","cb-col cb-col-100 cb-lst-itm cb-lst-itm-lg");
  ...
  /* Elements ell = document.getElementsByAttributeValue(others.attribute.attributename(sr), others.attribute.attributevalue(sr));
            for (Element at : ell) {
                if (others.attribute.hasAHref(at) == true && others.attribute.hasImgSrc(at) == true && at.hasText() == true) {
                    Elements links1 = at.getElementsByTag("a");
                    Elements links2 = at.getElementsByTag("img");
